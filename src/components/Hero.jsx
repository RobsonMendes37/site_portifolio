      ...
      {!isMobile ? (
        ...
        <div className="absolute inset-0 flex items-center justify-center overflow-hidden">
          <motion.div
            ...
            className="w-96 h-96 sm:w-[28rem] sm:h-[28rem] md:w-[32rem] md:h-[32rem] lg:w-[36rem] lg:h-[36rem] flex items-center justify-center"
          >
            {/* Imagem PNG do computador com zoom maior mas controlado */}
            <img 
              src={computador} 
              alt="Computer Setup" 
